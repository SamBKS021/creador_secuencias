function StartupOverlay({ open, progress = 0, detail = '' }) {
  ...
  return (
    <div className="fixed inset-0 z-[320] flex items-center justify-center bg-transparent px-4">
      <div className="w-full max-w-xl rounded-[34px] border border-[rgba(67,71,78,0.08)] bg-white px-7 py-8 shadow-[0_34px_90px_-34px_rgba(0,36,70,0.18)]">
        ...
        <div className="mt-8 space-y-3">
          <div className="h-2 overflow-hidden rounded-full bg-[rgba(0,36,70,0.08)]">
            <div
              className="h-full rounded-full bg-[linear-gradient(90deg,var(--primary)_0%,#5f95d6_100%)] transition-[width] duration-500 ease-out"
