...
function UploadDropzone({ onBrowse, disabled }) {
  return (
    <div className="rounded-[28px] bg-[var(--surface-container-high)] px-6 py-12 text-center">
      ...
      <h3 className="font-headline mt-6 text-3xl font-extrabold text-[var(--primary)]">Suelta aquí tus archivos `.docx`</h3>
      <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-[var(--on-surface-variant)]">
        Importa partituras o letras litúrgicas, crea un borrador editable y publícalo en la biblioteca del workspace activo.
      </p>
      <div className="mt-8">
